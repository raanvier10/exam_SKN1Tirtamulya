...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Perbarui parameter jadwal, target kelas, dan tautan kuesioner soal.</p>
        </div>
        <a href="{{ route('admin.exams.show', $exam->id) }}" class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-medium text-slate-600 bg-white border border-slate-200/80 hover:bg-slate-50 hover:text-indigo-600 transition-all shadow-2xs">
    ...
    <form action="{{ route('admin.exams.update', $exam->id) }}" method="POST" id="examForm" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            <a href="{{ route('admin.exams.show', $exam->id) }}" class="px-5 py-2.5 text-sm font-semibold bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 rounded-xl transition-colors shadow-2xs">
                Batal
            </a>
